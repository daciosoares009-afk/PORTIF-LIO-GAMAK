...
export const projects: Project[] = [
  ...
  { id: 13, title: 'Tratamento de impermeabilização', category: 'Manutenção', description: 'Execução de tratamento em área externa com organização das bases e encontros construtivos.', alt: 'Área externa de edifício durante execução de impermeabilização', objectPosition: '50% 62%', size: 'wide', ...projectImage('impermeabilizacao-area-externa-02') },
